...
----config----
local bot_api_key = " 208668705:AAH0ar8YPXZu9JPODZvPU9IKsqax2VEDNfs"توکن بوت را درون " --
local BASE_URL = "https://api.telegram.org/sceneboldbot"..bot_api_key
local BASE_FOLDER = ""
local start = [[
hi :)
...
function is_admin(msg)-- Check if user is admin or not
  local var = false
  local admins = {100096055}-- put your id here
